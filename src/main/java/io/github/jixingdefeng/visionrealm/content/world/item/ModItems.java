...
public class ModItems {
    ...
    public static final DeferredItem<Item> ERROR = ITEMS.register(
            "error_item",
            () -> new ErrorItem(new Item.Properties())
    );

    public static final DeferredItem<ConveyorItem> CONVEYOR_ITEM = ITEMS.register(
            "conveyor_item",
            () -> new ConveyorItem(new Item.Properties().stacksTo(1))
    );
