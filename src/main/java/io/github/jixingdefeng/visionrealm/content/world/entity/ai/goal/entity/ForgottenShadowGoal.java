package io.github.jixingdefeng.visionrealm.content.world.entity.ai.goal.entity;
...
public class ForgottenShadowGoal extends MeleeAttackGoal {
    private final ForgottenShadow mob;
    private int ticksUntilNextAttack;
    private int attackTimer;

    public ForgottenShadowGoal(ForgottenShadow mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
    ...
    protected boolean attackable(LivingEntity target) {
        return target != null && target.isAlive() && !(target instanceof Enemy && !(target instanceof Raider));
    }
