...
import io.github.jixingdefeng.visionrealm.content.world.level.block.grower.ModTreeGrower;
import io.github.jixingdefeng.visionrealm.content.world.level.block.state.BlockBehaviourExpand;
import io.github.jixingdefeng.visionrealm.content.world.level.block.state.properties.ModBlockSetTypes;
import io.github.jixingdefeng.visionrealm.content.world.level.block.state.properties.ModWoodTypes;
...
public class ModBlocks {
    ...
    // —————————————————————————————— 原版方块变体 ——————————————————————————————
    public static final DeferredBlock<Block> CURSED_CACTUS = registerBlockWithItem(
            "cursed_cactus",
            () -> new CursedCactusBlock(
    ...
    // 只注册方块，不需要注册物品
    public static final DeferredBlock<Block> POTTED_CURSED_CACTUS = registerBlock(
            "potted_cursed_cactus", flowerPot(CURSED_CACTUS, false)
    );
