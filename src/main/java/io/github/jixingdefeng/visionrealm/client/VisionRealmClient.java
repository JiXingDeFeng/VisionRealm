package io.github.jixingdefeng.visionrealm.client;

import io.github.jixingdefeng.visionrealm.VisionRealm;
import io.github.jixingdefeng.visionrealm.client.gui.InGameHud;
import io.github.jixingdefeng.visionrealm.client.gui.ScreenEffects;
import io.github.jixingdefeng.visionrealm.client.item.EnergyBarDecorator;
import io.github.jixingdefeng.visionrealm.client.renderer.entity.AdministratorRenderer;
import io.github.jixingdefeng.visionrealm.client.renderer.entity.monster.ForgottenShadowRenderer;
import io.github.jixingdefeng.visionrealm.client.renderer.entity.monster.NightmareApostleRenderer;
import io.github.jixingdefeng.visionrealm.content.particle.BloodCorrodedCherryParticle;
import io.github.jixingdefeng.visionrealm.content.particle.ErrorParticles;
...
public class VisionRealmClient {
    ...
    public static void registerItemDecorations(RegisterItemDecorationsEvent event) {
        event.register(ModItems.CONVEYOR_ITEM.get(), new EnergyBarDecorator());
    }
}
