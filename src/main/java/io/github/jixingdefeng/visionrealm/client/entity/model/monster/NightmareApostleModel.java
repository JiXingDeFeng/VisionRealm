...
@OnlyIn(Dist.CLIENT)
public class NightmareApostleModel<T extends LivingEntity> extends HierarchicalModel<T> implements ArmedModel {
    ...
    public NightmareApostleModel(ModelPart root) {
		this.overall = root.getChild("overall");
		this.head = this.overall.getChild("head");
        this.leftHand = this.overall.getChild("left_hand");
        this.rightHand = this.overall.getChild("right_hand");
        this.leftHand_2 = this.leftHand.getChild("left_hand_2");
        this.rightHand_2 = this.rightHand.getChild("right_hand_2");
	}
	...
	public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_foot_1 = right_foot.addOrReplaceChild("right_foot_1", CubeListBuilder.create().texOffs(32, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 36).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_foot_2 = right_foot.addOrReplaceChild("right_foot_2", CubeListBuilder.create().texOffs(32, 26).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition right_hand_1 = right_hand.addOrReplaceChild("right_hand_1", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 36).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition right_hand_2 = right_hand.addOrReplaceChild("right_hand_2", CubeListBuilder.create().texOffs(0, 26).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
    ...
    public void translateToHand(@NotNull HumanoidArm side, @NotNull PoseStack poseStack) {
        ModelPart hand = side == HumanoidArm.LEFT ? this.leftHand_2 : this.rightHand_2;
