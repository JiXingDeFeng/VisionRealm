 ...
 * <ol>
 *   <li>{@link #tryErosion(Block, Level, BlockPos, ErosionType)} is called to initiate the erosion attempt</li>
 ...
 *   <li>{@link #transformed(Object, Level, BlockPos, ErosionType, BlockErosionContext)} performs the actual conversion logic</li>
 ...
 * @since 0.0.1-dev
 */
public interface CanBeErosionBlock<RT, R> {
     ...
     */
    @Nullable
    R transformed(RT target, Level level, BlockPos pos, ErosionType type, BlockErosionContext context);
     ...
     * calls {@link BlockErosionHandler#tryErosion} to process the erosion.
     * </p>
     *
