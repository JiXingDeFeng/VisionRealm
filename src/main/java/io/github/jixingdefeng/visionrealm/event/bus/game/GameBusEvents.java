...
import io.github.jixingdefeng.visionrealm.core.data.erosion.config.block.BlockErosionConfigReloadListener;
...
public class GameBusEvents {
    ...
    public static void onAddReloadListenerEvent(AddReloadListenerEvent event) {
        ...
        event.addListener(new BlockErosionConfigReloadListener(new BlockErosionConfigManager()));
