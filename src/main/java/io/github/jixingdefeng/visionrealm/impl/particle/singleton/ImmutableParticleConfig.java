...
public record ImmutableParticleConfig(@NotNull ParticleOptions particleType, IntProvider countProvider, double speed,
    ...
    public static final ResourceLocation type = ResourceLocation.fromNamespaceAndPath(VisionRealm.MOD_ID, "default");
    ...
    public static ImmutableParticleConfig of(
        ...
        return of(particleType, count, speed, 0, 0, 0, xOffset, yOffset, zOffset);
    }
    ...
    public static ImmutableParticleConfig of(
        ...
        return of(particleType, maxCount, minCount, speed, 0, 0, 0, xOffset, yOffset, zOffset);
    }
