package io.github.jixingdefeng.visionrealm.core.entity.client.model;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import io.github.jixingdefeng.visionrealm.core.VisionRealm;
import io.github.jixingdefeng.visionrealm.core.entity.client.animation.TheForgottenAnimation;
...
public class TheForgottenModel<T extends TheForgottenEntity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VisionRealm.MOD_ID, "the_forgotten_model"), "main");
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(TheForgottenAnimation.move, limbSwing, limbSwingAmount, (float) (entity.getAttributeValue(Attributes.MOVEMENT_SPEED) * 6.6667F), ageInTicks);
        this.animate(entity.STANDING_ANIM, TheForgottenAnimation.standing, ageInTicks);
        this.animate(entity.STANDBY_ANIM, TheForgottenAnimation.standby, ageInTicks);
        this.animate(entity.ATTACK_ANIM[0], TheForgottenAnimation.attack_1, ageInTicks);
        this.animate(entity.ATTACK_ANIM[1], TheForgottenAnimation.attack_2, ageInTicks);
    }
