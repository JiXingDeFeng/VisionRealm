package io.github.jixingdefeng.visionrealm.core.util.particle;
...
public final class ParticleTemplates {
    public static final ImmutableParticleConfig LARGE_SMOKE = new ImmutableParticleConfig(ParticleTypes.LARGE_SMOKE, 1, 0.02, 0.5, 1, 0.5, 0, 1, 0);
