...
public class ModifiableParticleConfig implements SingletonParticleConfig {
    public static final ResourceLocation TYPE = ResourceLocation.fromNamespaceAndPath(VisionRealm.MOD_ID, "modifiable");
    ...
    public ModifiableParticleConfig(@NotNull ParticleOptions particleType, int count, double speed) {
        this(particleType, count, speed, 0, 0, 0);
    }

    public ModifiableParticleConfig(
        ...
        this(particleType, count, speed, spreadX, spreadY, spreadZ, 0);
    }
    ...
    public ModifiableParticleConfig(
        ...
        this(particleType, count, speed, spreadX, spreadY, spreadZ, 0, yOffset, 0);
    }
    ...
    public ResourceLocation getType() {
        return ModifiableParticleConfig.TYPE;
    }
