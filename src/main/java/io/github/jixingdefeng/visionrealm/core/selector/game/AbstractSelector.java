...
public abstract class AbstractSelector<T, S extends TargetSelector<T, S>> implements TargetSelector<T, S> {
    ...
    protected @Nullable Predicate<? super ResourceKey<Biome>> biomeFilter;
    ...
    @Override
    public S filterBiome(@Nullable Predicate<? super ResourceKey<Biome>> filter) {
    ...
    protected void copyFrom(AbstractSelector<?, ?> source) {
        ...
        this.biomeFilter = source.biomeFilter;
    ...
    protected static class Snapshot<T> {
        ...
        public final @Nullable Predicate<? super ResourceKey<Biome>> biomeFilter;
