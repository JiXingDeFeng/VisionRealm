package io.github.jixingdefeng.visionrealm.core.server.packs.resources.particle;
...
public class ParticleConfigReloadListener extends SimplePreparableReloadListener<Map<ResourceLocation, ParticleConfig>> {
    ...
    protected Map<ResourceLocation, ParticleConfig> prepare(
        ...
        resourceManager.listResources(ParticleConfigStore.PATH, location -> location.getPath().endsWith(".json"))
                .forEach((location, resource) -> {
                    try (var reader = resource.openAsReader()) {
                        ...
                        if (config instanceof EmptyParticleConfig) {
                            ...
                            path = PathUtil.removePrefix(path, ParticleConfigStore.PATH);
    ...
    protected void apply(
        ...
        ParticleConfigStore.getInstance()
                .ifPresent(manager -> manager.storePersistentMap(configMap));
    }
}
