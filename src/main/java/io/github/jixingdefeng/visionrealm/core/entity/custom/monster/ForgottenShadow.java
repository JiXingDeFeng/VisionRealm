...
import io.github.jixingdefeng.visionrealm.core.entity.ai.goal.LightAwareStrollGoal;
import io.github.jixingdefeng.visionrealm.core.entity.ai.goal.entity.ForgottenShadowGoal;
import io.github.jixingdefeng.visionrealm.core.entity.custom.Photophobic;
...
public class ForgottenShadow extends Monster implements
        Photophobic, LivingEntityExtensions, NightmareCreature, EntityParticleProvider {
    ...
    public void tick() {
        ...
        if (level instanceof ClientLevel clientLevel) {
            ...
            if (!isRaining && (dayTime < 500 || dayTime >= 12000 && dayTime < 12100)) {
    ...
    public boolean isWithinMeleeAttackRange(@NotNull LivingEntity entity) {
        return super.isWithinMeleeAttackRange(entity) || this.distanceToSqr(entity) <= 2.25;
    }
