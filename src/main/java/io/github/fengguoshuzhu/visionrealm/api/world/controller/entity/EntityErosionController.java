package io.github.fengguoshuzhu.visionrealm.api.world.controller.entity;
...
import io.github.fengguoshuzhu.visionrealm.mixin.world.event.entity.EntityErosionControllerMixin;
...
public interface EntityErosionController {
     ...
     * </p>
     *
     * @return The current erosion type, never null (defaults to {@link io.github.fengguoshuzhu.visionrealm.core.world.erosion.ErosionType#DREAD})
    ...
    default ErosionType getErosionType() {
        return io.github.fengguoshuzhu.visionrealm.core.world.erosion.ErosionType.NONE;
    }
