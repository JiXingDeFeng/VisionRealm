package io.github.fengguoshuzhu.visionrealm.api.world.erosion.infection.block;
...
public interface CanBeErosionBlock<T, R> extends CanBeErosion<Block, R, T> {
     ...
     * <p>
     * This implementation converts the Vec3 position to a BlockPos and delegates
     * to {@link #transformed(Object, Level, BlockPos, ErosionType, ErosionContext)}.
     * </p>
     *
    ...
    default R transformed(T target, Level level, Vec3 pos, ErosionType type, ErosionContext<Block> context) {
        return this.transformed(target, level, context.blockPos(), type, context);
    }
     ...
     */
    @Nullable
    R transformed(T target, Level level, BlockPos pos, ErosionType type, ErosionContext<Block> context);
     ...
     *
     * <p><b>Note:</b> This is passive/natural infection, distinct from active spread
     * (see {@link ErosionSpreaderBlock}). Server-side only.</p>
     *
