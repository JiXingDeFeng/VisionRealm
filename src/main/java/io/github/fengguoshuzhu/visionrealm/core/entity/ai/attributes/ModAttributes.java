package io.github.fengguoshuzhu.visionrealm.core.entity.ai.attributes;
...
public class ModAttributes {
    ...
    public static final Holder<Attribute> EROSION = ATTRIBUTES.register(
            "generic.erosion",
            () -> new PercentageAttribute("attribute.name.generic.erosion", 0, 0, 1).setSyncable(true)
    );
