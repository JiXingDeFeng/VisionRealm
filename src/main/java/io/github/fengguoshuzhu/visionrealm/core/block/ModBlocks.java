...
import io.github.fengguoshuzhu.visionrealm.core.block.grower.ModTreeGrower;
import io.github.fengguoshuzhu.visionrealm.core.block.state.BlockBehaviourExpand;
import io.github.fengguoshuzhu.visionrealm.core.block.state.properties.ModBlockSetTypes;
import io.github.fengguoshuzhu.visionrealm.core.block.state.properties.ModWoodTypes;
...
public class ModBlocks {
    ...
    public static class CustomBlocks {
        ...
        // 只注册方块
        public static final DeferredBlock<Block> LURKER_DISGUISE_BLOCK = registerBlock(
                "lurker_disguise_block",
                () -> new LurkerDisguiseBlock(
                        ParticleTypes.FLAME,
        ...
        public static final DeferredBlock<Block> LURKER_DISGUISE_WALL_BLOCK = registerBlock(
                "lurker_disguise_wall_block",
                () -> new LurkerDisguiseBlock.WallBlock(
                        ParticleTypes.FLAME,
                        ParticleTypes.SOUL_FIRE_FLAME,
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.COLOR_RED)
    ...
    public static class VanillaBlockVariants {
    ...
    private static Supplier<Block> stair(Supplier<Block> baseBlock) {
        return stair(baseBlock, false);
    }
